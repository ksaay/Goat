...
//Set up screen
   ...
   v0= IMG_Load("manette.png");
   v1= IMG_Load("clavier.png");
v2= IMG_Load("manette1.png");
   v3= IMG_Load("clavier1.png");
     if(image == NULL)
       {
...
position1.y=0;
 ...
 position3ecran.x=380;
   position3ecran.y=0;

   SDL_BlitSurface(image,NULL,screen,&positionecran);
      SDL_BlitSurface(v0,NULL,screen,&position2ecran);
      SDL_BlitSurface(v1,NULL,screen,&position3ecran);
...
if(p==1){
//v0= IMG_Load("manette1.png");
      SDL_BlitSurface(v2,&positionecran,screen,&position2ecran);
Mix_VolumeMusic(0);
 }
if(p==2){
  // v0 = IMG_Load("clavier1.png");
      SDL_BlitSurface(v3,&positionecran,screen,&position3ecran);
Mix_VolumeMusic(30);
 }
/*if(p==3){
